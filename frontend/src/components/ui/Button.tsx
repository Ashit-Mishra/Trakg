...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', isLoading, children, disabled, ...props }, ref) => {
    ...
    const variants = {
      primary: 'bg-primary text-white hover:bg-blue-700 shadow-sm focus:ring-primary',
      secondary: 'bg-secondary text-white hover:bg-green-700 shadow-sm focus:ring-secondary',
      outline: 'border-2 border-gray-200 bg-transparent text-text hover:bg-gray-50 focus:ring-gray-200',
